...
class ListView
{
    ...
    function CountRecord()
    {
		...
		$tempfile = $GLOBALS['cfg_basedir'].$GLOBALS['cfg_templets_dir']."/".$this->TypeLink->TypeInfos['templist'];
		$tempfile = str_replace($GLOBALS['cfg_df_style'], "wap", $tempfile);
        ...
        for($i=0;$i<$row;$i++)
        {
            ...
            for($j=0;$j<$col;$j++)
            {
                if($row = $this->dsql->GetArray("al"))
                {
                    ...
                    $row['typelink'] = "<span><a href='".$row['typeurl']."'>".$row['typename']."</a></span>";
                    $row['image'] = "<img src='".$row['picname']."' border='0' width='$imgwidth' height='$imgheight' alt='".preg_replace("/['><]/", "", $row['title'])."'>";
                    $row['imglink'] = "<span><a href='".$row['filename']."'>".$row['image']."</a></span>";
                    ...
                    $row['textlink'] = "<span><a href='".$row['filename']."'>".$row['title']."</a></span>";
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span><a class=\"thisclass\">$j\r\n";
            }
            else
            {
